...
class JudgementVariantList:
    ...
    def process_list(self):
        ...
        for variant_key,ref in data_dic.items():
            ...
            five_utr=any(self.is_five_prime_utr(v) for v in refseq_list + ensembl_list if v)
            three_utr=any(self.is_three_prime_utr(v) for v in refseq_list + ensembl_list if v)
            if five_utr:
                categories['5_prime_UTR'].append(variant_key)
            if three_utr:
                categories['3_prime_UTR'].append(variant_key)
            if not five_utr and not three_utr:
...
if __name__ == "__main__":
    ...
    final_path_GRch37='C:/Dissertation_project/Clinical-Genomics-Variant/LOVD_json/select_variant_changing_UTR/GRCh37_lovd.json'
    final_path_GRch38='C:/Dissertation_project/Clinical-Genomics-Variant/LOVD_json/select_variant_changing_UTR/GRCh38_lovd.json'
    judgement_file_path37_five = 'C:/Dissertation_project/Clinical-Genomics-Variant/LOVD_json/select_variant_changing_UTR/GRCh37/GRCh37_five_prime_utr.json'
    judgement_file_path37_three= 'C:/Dissertation_project/Clinical-Genomics-Variant/LOVD_json/select_variant_changing_UTR/GRCh37/GRCh37_three_prime_utr.json'
    judgement_file_path37_refseq= 'C:/Dissertation_project/Clinical-Genomics-Variant/LOVD_json/select_variant_changing_UTR/GRCh37/GRCh37_gaps_in_refseq_not_in_ensembl.json'
    judgement_file_path37_ensembl= 'C:/Dissertation_project/Clinical-Genomics-Variant/LOVD_json/select_variant_changing_UTR/GRCh37/GRCh37_gaps_not_in_refseq_in_ensembl.json'
    judgement_file_path37_refseq_ensembl= 'C:/Dissertation_project/Clinical-Genomics-Variant/LOVD_json/select_variant_changing_UTR/GRCh37/GRCh37_gap_in_refseq_and_ensembl.json'
    judgement_file_path37_no_gap= 'C:/Dissertation_project/Clinical-Genomics-Variant/LOVD_json/select_variant_changing_UTR/GRCh37/GRCh37_no_gap.json'
    judgement_file_path38_five = 'C:/Dissertation_project/Clinical-Genomics-Variant/LOVD_json/select_variant_changing_UTR/GRCh38/GRCh38_five_prime_utr.json'
    judgement_file_path38_three= 'C:/Dissertation_project/Clinical-Genomics-Variant/LOVD_json/select_variant_changing_UTR/GRCh38/GRCh38_three_prime_utr.json'
    judgement_file_path38_refseq= 'C:/Dissertation_project/Clinical-Genomics-Variant/LOVD_json/select_variant_changing_UTR/GRCh38/GRCh38_gaps_in_refseq_not_in_ensembl.json'
    judgement_file_path38_ensembl= 'C:/Dissertation_project/Clinical-Genomics-Variant/LOVD_json/select_variant_changing_UTR/GRCh38/GRCh38_gaps_not_in_refseq_in_ensembl.json'
    judgement_file_path38_refseq_ensembl= 'C:/Dissertation_project/Clinical-Genomics-Variant/LOVD_json/select_variant_changing_UTR/GRCh38/GRCh38_gap_in_refseq_and_ensembl.json'
    judgement_file_path38_no_gap= 'C:/Dissertation_project/Clinical-Genomics-Variant/LOVD_json/select_variant_changing_UTR/GRCh38/GRCh38_no_gap.json'
