...
def process_batch(batch, server, headers, sleep_time=2):
...
def main():
    ...
    db_name = os.path.join(dbs_dir, f'GRCh38_indels_variant.db')
    ...
    process_func = partial(process_batch, server=server, headers=headers)
